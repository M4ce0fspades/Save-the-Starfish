...
public class FirstPersonController : MonoBehaviour
{
    ...
    #endregion
    private readonly float rearBound = 247f;
    private readonly float frontBound = 271f;
    private readonly float sideBound = 100f;
    ...
    private void Update()
    {
        ...
        checkPositionRestraint();

    }
    void checkPositionRestraint()
    {
        if (transform.position.z < rearBound)
        {
            transform.position = new Vector3(transform.position.x, transform.position.y, rearBound);
        }
